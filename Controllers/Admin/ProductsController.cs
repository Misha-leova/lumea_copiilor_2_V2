...
namespace lumea_copiilor_2.Controllers.Admin
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Description,Price,Stock,ImageUrl,IsActive,CreatedAt,UpdatedAt")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,Description,Price,Stock,ImageUrl,IsActive,CreatedAt,UpdatedAt")] Product product)
        {
